...
#define OS_TARGET_PORT "VRTA"
#define OS_TARGET_PORT_VRTA
#define OS_TARGET_MAJOR_VERSION (3U)
#define OS_TARGET_MINOR_VERSION (0U)
#define OS_TARGET_PATCH_VERSION (41U)
...
#include "vrtaCore.h"
/* [MISRA 2012 Dir 4.9] */ /*lint -estring(9026, CAT1_ISR, OS_RETURNS_TWICE, OS_NO_RETURN, OS_NAKED) */
...
extern void Os_ISRWrapper(const void * tag, vrtaIntPriority oldIPL);
 ...
 #endif
#define OS_RETURNS_TWICE(fn) fn
#define OS_NO_RETURN(fn) fn
#define OS_NAKED
#else


#define OS_RETURNS_TWICE(fn) fn __attribute__ ((returns_twice))
#define OS_NO_RETURN(fn) fn  __attribute__ ((noreturn))
#endif

typedef vrtaUInt Os_ISRSourceType;
extern boolean Os_VRTA_IsDisabledInterrupt(vrtaUInt source_info);
extern void Os_VRTA_ClearPendingInterrupt(vrtaUInt source_info);
extern void Os_VRTA_EnableInterrupt(vrtaUInt source_info);
extern void Os_VRTA_DisableInterrupt(vrtaUInt source_info);
...
typedef unsigned int Os_jump_buf[6];
extern OS_RETURNS_TWICE(Os_SetJmpType Os_SetJmp(Os_jump_buf *env));
extern OS_NO_RETURN(void Os_LongJmp(Os_jump_buf *env, Os_SetJmpType val));
...
typedef unsigned int Os_StackTraceType;
typedef unsigned int Os_StackValueType;
typedef unsigned int Os_StackSizeType;
...
/* OSApplications */
typedef unsigned char Os_ApplicationType; /* [$UKS 411] */
...
typedef int Os_tmaskType; /* [$UKS 2047] */
...
#define OSServiceId_ActivateTaskAsyn ((OSServiceIdType)2)
#define OSServiceId_Os_AdvanceCounter ((OSServiceIdType)3)
#define OSServiceId_CancelAlarm ((OSServiceIdType)4)
#define OSServiceId_CallTrustedFunction ((OSServiceIdType)5)
#define OSServiceId_CheckISRMemoryAccess ((OSServiceIdType)6)
#define OSServiceId_CheckObjectAccess ((OSServiceIdType)7)
#define OSServiceId_CheckObjectOwnership ((OSServiceIdType)8)
#define OSServiceId_CheckTaskMemoryAccess ((OSServiceIdType)9)
#define OSServiceId_ChainTask ((OSServiceIdType)10)
#define OSServiceId_ClearEvent ((OSServiceIdType)11)
#define OSServiceId_ControlIdle ((OSServiceIdType)12)
...
#define OSServiceId_Os_GetTaskActivationTime ((OSServiceIdType)35)
#define OSServiceId_Os_GetTaskMaxExecutionTime ((OSServiceIdType)36)
#define OSServiceId_Os_ResetISRMaxExecutionTime ((OSServiceIdType)37)
#define OSServiceId_Os_ResetTaskMaxExecutionTime ((OSServiceIdType)38)
#define OSServiceId_Os_GetElapsedTime ((OSServiceIdType)39)
#define OSServiceId_Os_GetTaskElapsedTime ((OSServiceIdType)40)
#define OSServiceId_Os_GetISRElapsedTime ((OSServiceIdType)41)
#define OSServiceId_Os_GetIdleElapsedTime ((OSServiceIdType)42)
#define OSServiceId_Os_ResetTaskElapsedTime ((OSServiceIdType)43)
#define OSServiceId_Os_ResetISRElapsedTime ((OSServiceIdType)44)
#define OSServiceId_Os_ResetIdleElapsedTime ((OSServiceIdType)45)
#define OSServiceId_Os_GetStackSize ((OSServiceIdType)46)
#define OSServiceId_Os_GetStackUsage ((OSServiceIdType)47)
#define OSServiceId_Os_GetStackValue ((OSServiceIdType)48)
#define OSServiceId_Os_GetISRMaxStackUsage ((OSServiceIdType)49)
#define OSServiceId_Os_GetTaskMaxStackUsage ((OSServiceIdType)50)
#define OSServiceId_Os_ResetISRMaxStackUsage ((OSServiceIdType)51)
#define OSServiceId_Os_ResetTaskMaxStackUsage ((OSServiceIdType)52)
#define OSServiceId_ReleaseResource ((OSServiceIdType)53)
#define OSServiceId_Restart ((OSServiceIdType)54)
#define OSServiceId_ResumeAllInterrupts ((OSServiceIdType)55)
#define OSServiceId_ResumeOSInterrupts ((OSServiceIdType)56)
#define OSServiceId_Schedule ((OSServiceIdType)57)
#define OSServiceId_SetEvent ((OSServiceIdType)58)
#define OSServiceId_SetEventAsyn ((OSServiceIdType)59)
#define OSServiceId_SetAbsAlarm ((OSServiceIdType)60)
#define OSServiceId_SetRelAlarm ((OSServiceIdType)61)
#define OSServiceId_SetRestartPoint ((OSServiceIdType)62)
#define OSServiceId_ShutdownOS ((OSServiceIdType)63)
#define OSServiceId_StartOS ((OSServiceIdType)64)
#define OSServiceId_StartScheduleTableAbs ((OSServiceIdType)65)
#define OSServiceId_StartScheduleTableRel ((OSServiceIdType)66)
#define OSServiceId_StartScheduleTableSynchron ((OSServiceIdType)67)
#define OSServiceId_SyncScheduleTable ((OSServiceIdType)68)
#define OSServiceId_SyncScheduleTableRel ((OSServiceIdType)69)
#define OSServiceId_SetScheduleTableAsync ((OSServiceIdType)70)
#define OSServiceId_StopScheduleTable ((OSServiceIdType)71)
#define OSServiceId_SuspendAllInterrupts ((OSServiceIdType)72)
#define OSServiceId_SuspendOSInterrupts ((OSServiceIdType)73)
#define OSServiceId_TerminateApplication ((OSServiceIdType)74)
#define OSServiceId_TerminateTask ((OSServiceIdType)75)
#define OSServiceId_WaitEvent ((OSServiceIdType)76)
#define OSServiceId_EnableInterruptSource ((OSServiceIdType)77)
#define OSServiceId_DisableInterruptSource ((OSServiceIdType)78)
#define OSServiceId_ClearPendingInterrupt ((OSServiceIdType)79)
#define OSServiceId_ModifyPeripheral32 ((OSServiceIdType)80)
#define OSServiceId_ReadPeripheral32 ((OSServiceIdType)81)
#define OSServiceId_WritePeripheral32 ((OSServiceIdType)82)
#define OSServiceId_ModifyPeripheral16 ((OSServiceIdType)83)
#define OSServiceId_ReadPeripheral16 ((OSServiceIdType)84)
#define OSServiceId_WritePeripheral16 ((OSServiceIdType)85)
#define OSServiceId_ModifyPeripheral8 ((OSServiceIdType)86)
#define OSServiceId_ReadPeripheral8 ((OSServiceIdType)87)
#define OSServiceId_WritePeripheral8 ((OSServiceIdType)88)
#define OSServiceId_AllowAccess ((OSServiceIdType)89)
#define OSServiceId_GetApplicationState ((OSServiceIdType)90)
/* Error logging  */
...
#define StartOS(x) {Os_StackBase = Os_GetSP(); if (Os_StartOS(x)) {while(Os_Cbk_Idle()) {} /* [$UKS 161] */; for(;;) {vrtaYield(0U);} /* [$UKS 16] */}}
...
#include "MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern OS_VOLATILE VAR(Os_psetType, OS_VAR_NOINIT) Os_ReadyTasks /*lint --e(9018) A union type */;
extern OS_VOLATILE VAR(ISRType, OS_VAR_NOINIT) Os_RunningISR;
extern OS_VOLATILE VAR(TaskType, OS_VAR_NOINIT) Os_RunningTask;
extern OS_VOLATILE VAR(Os_tpmaskType, OS_VAR_NOINIT) Os_RunningTPMask /*lint --e(9018) A union type */;
