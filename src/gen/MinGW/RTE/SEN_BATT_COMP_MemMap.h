...
#elif defined(SEN_BATT_COMP_START_SEC_CODE)
#undef SEN_BATT_COMP_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(SEN_BATT_COMP_STOP_SEC_CODE)
#undef SEN_BATT_COMP_STOP_SEC_CODE
