...
TASK(OsTask_23)
{
   for ( ; ; )
   {
      WaitEvent(Rte_Ev_CPT_ACT_HYDRAULIC_MODULATOR_FRONTR_COMP_DataReceivedEvent_0);
      ClearEvent(Rte_Ev_CPT_ACT_HYDRAULIC_MODULATOR_FRONTR_COMP_DataReceivedEvent_0);
      ...
      {
         /* Box: CPT_ACT_HYDRAULIC_MODULATOR_FRONTR_COMP begin */
         RE_ACT_FR_Data_Recev_func();
         /* Box: CPT_ACT_HYDRAULIC_MODULATOR_FRONTR_COMP end */
      }
