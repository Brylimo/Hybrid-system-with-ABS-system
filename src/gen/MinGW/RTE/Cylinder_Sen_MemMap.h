...
#elif defined(Cylinder_Sen_START_SEC_CODE)
#undef Cylinder_Sen_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(Cylinder_Sen_STOP_SEC_CODE)
#undef Cylinder_Sen_STOP_SEC_CODE
