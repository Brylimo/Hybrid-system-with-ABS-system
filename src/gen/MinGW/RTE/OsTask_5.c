...
extern VAR(Rte_REActCounterType, RTE_DATA) Rte_ActCount_CPT_AccelControlAPP_ExternalTriggerOccurredEvent_1;
...
TASK(OsTask_5)
{
   ...
   if ( Rte_ActCount_CPT_AccelControlAPP_ExternalTriggerOccurredEvent_1 != FALSE )
   {
      Rte_ActCount_CPT_AccelControlAPP_ExternalTriggerOccurredEvent_1 = FALSE;
      RE_battary_is_low_func();
   }
