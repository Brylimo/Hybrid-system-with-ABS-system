...
TASK(OsTask_3)
{
   for ( ; ; )
   {
      WaitEvent(Rte_Ev_CPT_ACT_HYDRAULIC_MODULATOR_REARL_COMP_DataReceivedEvent_0);
      ClearEvent(Rte_Ev_CPT_ACT_HYDRAULIC_MODULATOR_REARL_COMP_DataReceivedEvent_0);
      ...
      {
         /* Box: CPT_ACT_HYDRAULIC_MODULATOR_REARL_COMP begin */
         RE_ACT_RL_Data_Recev_func();
         /* Box: CPT_ACT_HYDRAULIC_MODULATOR_REARL_COMP end */
      }
