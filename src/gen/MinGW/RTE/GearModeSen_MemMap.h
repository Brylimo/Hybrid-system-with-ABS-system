...
#elif defined(GearModeSen_START_SEC_CODE)
#undef GearModeSen_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(GearModeSen_STOP_SEC_CODE)
#undef GearModeSen_STOP_SEC_CODE
