/** @file     Rte_APP_BRAKE_CONTROLL_COMP_Type.h
  *
...
#ifndef RTE_APP_BRAKE_CONTROLL_COMP_TYPE_H
#define RTE_APP_BRAKE_CONTROLL_COMP_TYPE_H
...
#endif /* !RTE_APP_BRAKE_CONTROLL_COMP_TYPE_H */
