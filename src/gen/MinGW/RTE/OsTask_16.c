...
extern VAR(Rte_REActCounterType, RTE_DATA) Rte_ActCount_CPT_APP_BRAKE_CONTROLL_COMP_DataReceivedEvent_3;
...
TASK(OsTask_16)
{
   ...
   if ( Rte_ActCount_CPT_APP_BRAKE_CONTROLL_COMP_DataReceivedEvent_3 != FALSE )
   {
      Rte_ActCount_CPT_APP_BRAKE_CONTROLL_COMP_DataReceivedEvent_3 = FALSE;
      RE_APP_RR_DATA_RECEV_func();
   }
