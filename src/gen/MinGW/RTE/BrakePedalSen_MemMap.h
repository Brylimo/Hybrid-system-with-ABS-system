...
#elif defined(BrakePedalSen_START_SEC_CODE)
#undef BrakePedalSen_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(BrakePedalSen_STOP_SEC_CODE)
#undef BrakePedalSen_STOP_SEC_CODE
