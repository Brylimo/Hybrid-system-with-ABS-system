...
#elif defined(AccelPedalSen_START_SEC_CODE)
#undef AccelPedalSen_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(AccelPedalSen_STOP_SEC_CODE)
#undef AccelPedalSen_STOP_SEC_CODE
