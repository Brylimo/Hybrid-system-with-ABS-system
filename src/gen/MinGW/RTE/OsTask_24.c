...
extern VAR(Rte_REActCounterType, RTE_DATA) Rte_ActCount_CPT_APP_BRAKE_CONTROLL_COMP_DataReceivedEvent_2;
...
TASK(OsTask_24)
{
   ...
   if ( Rte_ActCount_CPT_APP_BRAKE_CONTROLL_COMP_DataReceivedEvent_2 != FALSE )
   {
      Rte_ActCount_CPT_APP_BRAKE_CONTROLL_COMP_DataReceivedEvent_2 = FALSE;
      RE_APP_RL_DATA_RECEV_func();
   }
