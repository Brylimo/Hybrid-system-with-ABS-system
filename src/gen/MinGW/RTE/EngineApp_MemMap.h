...
#elif defined(EngineApp_START_SEC_CODE)
#undef EngineApp_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(EngineApp_STOP_SEC_CODE)
#undef EngineApp_STOP_SEC_CODE
