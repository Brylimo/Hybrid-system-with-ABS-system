 ...
 */
 ...
 /* This requires that Os.h be included first, however, if Os_EVE.h
  * is included then the combo of Os.h + Os_EVE.h is invalid.
  * Os_EVE.h does not include the subsection that includes where
  * OS_TARGET_VARIANT_RTPC_64bit is defined
  */
#if defined(OS_TARGET_VARIANT_RTPC_64bit)
	#define EVE_RTPC_SUPPORT
#endif

/* VECU System Clock Period:
